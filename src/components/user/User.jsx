...
import { Card, Avatar, Menu, theme } from 'antd';
...
const User = () => {
  return (
    <Container>
      ...
      >
        <StyledMeta
          theme={{ token: { colorBgBase: '#191919' } }}
          avatar={
            <Avatar src="https://ih1.redbubble.net/image.3632891702.9945/st,small,845x845-pad,1000x1000,f8f8f8.jpg" />
          }
          title="Team2"
        />
        <p>조은상, 주하림, 안태욱, 이용수</p>
